...
exports.pushNewCall = function (Suit, callName, args) {
  ...
  if (!(Suit[containerName] instanceof Array)) {
    Object.defineProperty(Suit, containerName, {
      value: [],
      writable: false,
      enumerable: false
    });
...
exports.extendSuit = function (Suit, descr) {
  Object.keys(descr).forEach(function (key) {
    Object.defineProperty(Suit, key, {
      value: descr[key],
      enumerable: false,
      writable: false
    });
  });
  Object.defineProperty(Suit.prototype, "suit", {
    value: Suit,
    enumerable: false,
    writable: false
  });
...
exports.isSuit = function (obj) {
  return (obj instanceof Function) && (obj.prototype) && (obj.prototype.hasOwnProperty("suit"));
};
...
exports.resetStubs = function (Suit) {
  Suit.stubs.forEach(stub => stub.resetHistory());
}
